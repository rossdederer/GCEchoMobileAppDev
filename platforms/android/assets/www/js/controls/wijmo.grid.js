    ...
    (function (grid) {
        ...
        */
        var FlexGrid = (function (_super) {
            ...
            */
            function FlexGrid(element, options) {
                ...
                */
                ...
                var e = this.hostElement, self = this, csh = getComputedStyle(e), csb = getComputedStyle(document.body), defRowHei = parseInt(csh.fontSize && wijmo.contains(document.body, e) ? csh.fontSize : csb.fontSize) * 2;
                ...
                */
                ...
                set: function (value) {
                    if (value != this.showMarquee) {
                        ...
                        s.visibility = 'hidden'; // show only after positioning
            ...
            */
            FlexGrid.prototype.getMergedRange = function (panel, r, c, clip) {
                if (typeof clip === "undefined") { clip = true; }
                return this._mrgMgr ? this._mrgMgr.getMergedRange(panel, r, c, clip) : null;
            };
            ...
            */
            ...
            FlexGrid.prototype._bindGrid = function (full) {
                ...
                self.deferUpdate(function () {
                    ...
                    // save selected items
                    var selItems = [];
                    if (self.selectionMode == 5 /* ListBox */) {
            ...
            FlexGrid.prototype._updateContent = function (recycle, state) {
                var self = this, focus = this.containsFocus(), hdrFocus = wijmo.contains(this.columnHeaders.hostElement, document.activeElement), pct = 1;
                ...
                if (this.showMarquee) {
                    ...
                    if (!sel.isValid || !this.rows.length || !this.columns.length) {
                        ...
                        wijmo.setCss(marquee, {
                            ...
                            visibility: rcm.width > 0 && rcm.height > 0 ? '' : 'hidden'
                        });
                    }
                }
                ...
                if (focus && !state) {
                    setTimeout(function () {
                        if (!self.containsFocus()) {
                            if (hdrFocus) {
                                self.columnHeaders.hostElement.focus(); // avoid scrolling if possible
                            } else {
                                self.focus();
                            }
                        }
    ...
    (function (grid) {
        ...
        */
        var CellRangeEventArgs = (function (_super) {
            ...
            */
            function CellRangeEventArgs(panel, rng, data) {
                _super.call(this);
        ...
        var GridPanel = (function () {
                ...
                if (this._ct == 1 /* Cell */) {
                    ...
                    if (col.dataMap && value != null) {
                        if (col.required || (value != '' && value != null)) {
                            var map = col.dataMap, key = map.getKeyValue(value);
                            if (key == null) {
            ...
            */
            GridPanel.prototype.getSelectedState = function (r, c, rng) {
                ...
                if (g.selectionMode != 0 /* None */) {
                    switch (this._ct) {
                        case 1 /* Cell */:
                            return g.getSelectedState(r, c);
                        case 2 /* ColumnHeader */:
                            if (g.showSelectedHeaders & 1 /* Column */) {
                                if (g.columns[c].isSelected || sel.containsColumn(c)) {
                                    if (rng)
                                        r = rng.bottomRow;
                        ...
                        case 3 /* RowHeader */:
                            if (g.showSelectedHeaders & 2 /* Row */) {
                                if (g.rows[r].isSelected || sel.containsRow(r)) {
                                    if (rng)
                                        r = rng.rightCol;
            ...
            */
            GridPanel.prototype._updateContent = function (recycle, state, offsetY) {
                ...
                // done if recycling, not udpating state, and old range contains new (unbuffered)
            ...
            GridPanel.prototype._renderCell = function (r, c, vrng, state, ctr) {
                ...
                var mrng = this._g.getMergedRange(this, r, c);
                if (mrng) {
                    if ((r > vrng.topRow && mrng.row < r) || (c > vrng.leftCol && mrng.col < c)) {
                        return ctr;
                    }
                }
                ...
                this._g.cellFactory.updateCell(this, r, c, cell, mrng);
    ...
    (function (grid) {
        ...
        */
        var CellFactory = (function () {
            ...
            */
            CellFactory.prototype.updateCell = function (panel, r, c, cell, rng, updateContent) {
                var g = panel.grid, ct = panel.cellType, rows = panel.rows, cols = panel.columns, row = rows[r], col = cols[c], r2 = r, c2 = c, gr = wijmo.tryCast(row, grid.GroupRow), nr = wijmo.tryCast(row, grid._NewRowTemplate), cellWidth = col.renderWidth, cellHeight = row.renderHeight, cl = 'wj-cell', css = { display: '' }, canSkip = (updateContent != false);
                ...
                // selected state
                var selState = panel.getSelectedState(r, c, rng);
                ...
                if (updateContent != false) {
                    var data = panel.getCellData(r, c, false), content = panel.getCellData(r, c, true);
                    if (ct == 1 /* Cell */ && c == g.columns.firstVisibleIndex && gr && gr.hasChildren && !this._isEditingCell(g, r, c)) {
                    ...
                    } else if (ct == 1 /* Cell */ && col.dataType == 3 /* Boolean */ && (!gr || wijmo.isBoolean(data))) {
                        ...
                        if (!col.inputType) {
                            inpType = col.dataType == 2 /* Number */ && !col.dataMap ? 'tel' : 'text';
                        }

                        // get editor value (use full precision when editing)
                        if (!col.dataMap && !col.mask) {
                            var val = panel.getCellData(r, c, false);
                            if (wijmo.isNumber(val)) {
                                var fmt = col.format ? col.format.replace(/(\d)+/g, '12') : null;
                        ...
                        edt.value = content;
                        edt.style.textAlign = col.getAlignment(); // right-align numbers when editing
                ...
                if (g.formatItem.hasHandlers) {
                    var e = new grid.FormatItemEventArgs(panel, new grid.CellRange(r, c), cell);
                    g.onFormatItem(e);
                }
            };
            ...
            */
            ...
            GroupRow.prototype._setCollapsed = function (collapsed) {
                ...
                g.deferUpdate(function () {
                    ...
                    self._setFlag(64 /* Collapsed */, collapsed);
        ...
        var HitTestInfo = (function () {
            ...
            */
            function HitTestInfo(grid, pt) {
                ...
                var rc = grid.controlRect, tlp = grid.topLeftCells, sp = grid.scrollPosition, sz = grid.clientSize, hdrVis = grid.headersVisibility, hdrWid = (hdrVis & 2 /* Row */) ? tlp.columns.getTotalSize() : 0, hdrHei = (hdrVis & 1 /* Column */) ? tlp.rows.getTotalSize() : 0;
                ...
                if (this._p == null && pt.x >= 0 && pt.y >= 0 && sz && pt.x <= sz.width + hdrWid && pt.y <= sz.height + hdrHei) {
            ...
            Object.defineProperty(HitTestInfo.prototype, "gridPanel", {
                ...
                */
                get: function () {
                    console.error('** This property is deprecated. Please use the "panel" property instead.');
                    return this._p;
                },
                enumerable: true,
                configurable: true
            ...
            Object.defineProperty(HitTestInfo.prototype, "cellRange", {
                ...
                */
                get: function () {
                    console.error('** This property is deprecated. Please use the "range" property instead.');
                    return new _grid.CellRange(this._row, this._col);
                },
                enumerable: true,
                configurable: true
    ...
    (function (_grid) {
        ...
        */
        var MergeManager = (function () {
            ...
            * @return A @see:CellRange that specifies the merged range, or null if the cell is not merged.
            */
            MergeManager.prototype.getMergedRange = function (panel, r, c, clip) {
                if (typeof clip === "undefined") { clip = true; }
                ...
                if (cols[c].allowMerging) {
                    ...
                    for (var tr = r - 1; tr >= rMin && this._mergeCell(panel, tr, c, r, c); tr--) {
                        rng.row = tr;
                    }
                    for (var br = r + 1; br <= rMax && this._mergeCell(panel, r, c, br, c); br++) {
                        rng.row2 = br;
                    }
                ...
                if (rows[r].allowMerging) {
                    ...
                    for (var cl = c - 1; cl >= cMin && this._mergeCell(panel, r, cl, r, c); cl--) {
                        rng.col = cl;
                    }
                    for (var cr = c + 1; cr <= cMax && this._mergeCell(panel, r, c, r, cr); cr++) {
                        rng.col2 = cr;
                    }
            ...
            MergeManager.prototype._mergeCell = function (p, r1, c1, r2, c2) {
                ...
                // not vertical merging if the range is already merged horizontally
                if (r1 != r2) {
                    if (c1 > 0) {
            ...
            */
            MergeManager.prototype.implementsInterface = function (interfaceName) {
        ...
        var _SelectionHandler = (function () {
                ...
                */
                ...
                set: function (value) {
                    if (value != this._mode) {
                        ...
                        switch (value) {
                            case 0 /* None */:
                                this._sel.row = this._sel.row2 = this._sel.col = this._sel.col2 = -1;
                                break;
                            case 1 /* Cell */:
            ...
            */
            ...
            _SelectionHandler.prototype._getReferenceCell = function (rowMove, colMove, extend) {
                var g = this._g, sel = g.selection, rng = g.getMergedRange(g.cells, sel.row, sel.col);
            ...
            */
            ...
            _KeyboardHandler.prototype._keydown = function (e) {
                ...
                if (g.isRangeValid(sel) && !e.defaultPrevented) {
                    ...
                    if (!g.activeEditor && e.target instanceof HTMLInputElement) {
                        return;
                    }
        ...
        var _MouseHandler = (function () {
            ...
            */
            function _MouseHandler(grid) {
                ...
                grid.addEventListener(e, 'mousedown', function (e) {
                    if (e.button == 0) {
                ...
                grid.addEventListener(e, 'mousemove', this._hover.bind(this));

                // double-click to auto-size rows/columns and to enter edit mode
                grid.addEventListener(e, 'dblclick', this._dblClick.bind(this));

                // prevent user from selecting grid content (as text)
                grid.addEventListener(e, 'selectstart', function (e) {
                ...
                grid.addEventListener(e, 'dragstart', this._dragStart.bind(this));
                grid.addEventListener(e, 'dragover', this._dragOver.bind(this));
                grid.addEventListener(e, 'dragleave', this._dragOver.bind(this));
                grid.addEventListener(e, 'drop', this._drop.bind(this));
                grid.addEventListener(e, 'dragend', this._dragEnd.bind(this));
            ...
            */
            ...
            _MouseHandler.prototype._mouseDown = function (e) {
                ...
                if (e.defaultPrevented || ht.cellType == 0 /* None */) {
                    return;
                }
                ...
                // but give focus to the cell rather than to the grid; this prevents the
                // browser from trying to scroll the whole grid into view
                if (e.target != document.activeElement && !g.containsFocus()) {
                    // travel up to cell (TFS 78295, 120361)
                    var cell = e.target;
                    while (cell instanceof Node && !wijmo.hasClass(cell, 'wj-cell')) {
                        cell = cell.parentNode;
                    }

                    // give focus to cell, panel, or grid
                    if (ht.panel == g.cells && cell instanceof HTMLElement) {
                        var fc = cell.firstElementChild;
                        ...
                        var p = ht.panel.hostElement.parentElement;
                        if (p.tabIndex < 0) {
                            p.tabIndex = 0;
                        }
                        p.focus();
                    ...
                    // still don't have it? focus on the whole grid
                    if (!g.containsFocus()) {
                        g.focus();
                    }
                }
            ...
            _MouseHandler.prototype._mouseUp = function (e) {
                ...
                if (htd && htd.cellType == 4 /* TopLeft */ && !this._szArgs) {
            ...
            _MouseHandler.prototype._mouseSelect = function (e, extend) {
                if (this._htDown && this._htDown.panel && this._g.selectionMode != 0 /* None */) {
                    var g = this._g, ht = new _grid.HitTestInfo(this._htDown.panel, e);
        ...
        var _EditHandler = (function () {
            ...
            function _EditHandler(grid) {
                    ...
                    if (ht.cellType != 1 /* Cell */ && ht.cellType != 0 /* None */) {
                        ...
                        if (edt && edt.type == 'checkbox' && wijmo.hasClass(edt.parentElement, 'wj-cell')) {
                            if (edt != self.activeEditor) {
                                ...
                                // if startEditing returns false, remember to ignore the next click event
                ...
                grid.addEventListener(grid.hostElement, 'click', function (e) {
                    ...
                    if (self._htDown && !self.activeEditor) {
                        ...
                        if (ht.range.equals(self._htDown.range)) {
            ...
            */
            ...
            _EditHandler.prototype._toggleDropDown = function (ht) {
                ...
                if (this._lbx) {
                    this._removeListBox();
                    if (g.selection.contains(ht.range)) {
                        if (g.activeEditor) {
            ...
            _EditHandler.prototype._createListBox = function () {
                ...
                // close listbox when clicking the selected item (TFS 96980)
                var self = this;
                ...
                lbx.addEventListener(lbx.hostElement, 'blur', this._blur.bind(this), true);
